...
AnimationEventSystem::AnimationEventSystem(entt::registry& registry, entt::dispatcher& dispatcher)
    ...
    dispatcher_.sink<engine::utils::AnimationEvent>().connect<&AnimationEventSystem::on_animation_event>(this);
}
...
void AnimationEventSystem::on_animation_event(const engine::utils::AnimationEvent& event) {
...
void AnimationEventSystem::handle_hit_event(const engine::utils::AnimationEvent& event) {
    // 玩家命中事件：治疗或攻击当前目标
